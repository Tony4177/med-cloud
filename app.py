...
# 2. CSS - ALL PAGES (Locked Sign-in + Doctor Help Header)
st.markdown("""
    <style>
    ...
    /* FORGOT ID: No box, Small text, 1.5cm Gap (Locked) */
    ...
    /* TOP BAR FOR MAIN PAGE (Doctor Help) */
    .dashboard-header {
        display: flex;
...
# --- PAGE 3: MAIN PAGE (DOCTOR HELP) ---
elif st.session_state.page == "dashboard":
    # Custom Header: Profile | Doctor Help | Menu
    st.markdown("""
